...
Control Flow Integrity (CFI) \cite{cfi} is a basic safety property that can prevent attacks from
...
main barrier to CFI's adoption seems to be the overhead associated with the scheme. In \cite{cfi},
...
then the implemenation of CFI in \cite{cfi} cannot be utilized.
